                    ...
                    <section class="container">
                        <div class="d-flex justify-content-center mt-1">
                            <section class="w-50" id="addNewModal">
                                ...
                                <div class="header">
                                    <h1 id="tmodal-update">ADD Dịch Vụ</h1>
                                </div>

                                <div class="body">
                                    <form:form id="form-data" action="addNew" method="post" modelAttribute="dichVu-Form">
                                        <div class="modal-body row">
                                            ...
                                            <div class="col-12">
                                                ...
                                                <form:input path="maDV" id="id-MaDV" class="form-control" type="text" placeholder="DV001" />

                                                <div class="error-message text-danger pt-3">
                                                    <span id="id-maDV-error"></span>
                                                    <form:errors path="maDV"></form:errors>
                                                </div>
                                            </div>
                                        ...
                                        <div class="modal-footer">
                                            ...
                                            <button onclick="validateDV(event)" type="submit" id="id-submit" class="btn btn-success">Submit</button>
