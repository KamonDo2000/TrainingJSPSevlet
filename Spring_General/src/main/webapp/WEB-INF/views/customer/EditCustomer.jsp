...
<section class="container">
    <div class="d-flex justify-content-center mt-1">
      <section class="w-50" id="addNewModal">
        ...
        <div class="header">
          <h1 id="tmodal-update">Edit Khách Hàng</h1>
        </div>

        <div class="body">
          <form:form id="form-data" action="update" method="post" modelAttribute="customer-Form">
            <div class="modal-body row">

              <form:input path="maKH" id="id-MaKH" type="hidden" />
            ...
            <div class="modal-footer">
	          ...
	          <button onclick="validateKH(event)" type="submit" id="id-submit" class="btn btn-primary">
	            Edit
	          </button>
            </div>
          </form:form>
